...
public class GamePanel extends JPanel implements Runnable {
	...
	// Max maps that can be created but can be modified
	...
	public GamePanel() {
		...
		this.setDoubleBuffered(true); // Set to true for better game rendering
	...
	public void setupGame() {
		...
		// Needed for full screen
		// Original is TYPE_INT_ARG
		tempScreen = new BufferedImage(screenWidth, screenHeight, BufferedImage.TYPE_INT_BGR);
		// Remove the pre to have the default method above
